...
void GuiApp::setup(){
    ...
    guiBreather.add(tuneBreatherExpansionRadius.set("Tune Expansion Radius Factor", 3.0, 1., 5.));
    guiBreather.add(tuneBreatherOscillationAmount.set("Tune Oscillation Amount", 0.1, 0., 0.2));
    ...
    string defaultSimulationPreset = "../../../../Presets/Simulation/BreathersReTuned01.xml";   
