...
void GuiApp::setup(){
    ...
    guiTimingsCells.add(cellNextGrowth.set("Cell Next Growth", glm::vec2(500, 0.5), glm::vec2(100, 0.), glm::vec2(3000, 1.)));
    ...
    guiTimingsNeurons.add(neuronGrowSpeed.set("Neuron Grow Speed", 1000, 100, 3000));
    guiTimingsNeurons.add(neuronSignalInterval.set("Neuron Signal Inteval", 1000, 100, 3000));
    guiTimings.add(guiTimingsNeurons);
    
    guiTimingsIntestines.setName("Intestines");
    guiTimingsIntestines.add(intestineGrowInterval.set("Intestine Grow Interval", 1000, 100, 3000.));
    guiTimingsIntestines.add(intestineDigestionInterval.set("Intestine Digestion Interval", 4000, 1000, 7000));
    guiTimingsIntestines.add(intestineDigestionSpeed.set("Intestine Digestion Speed", 500, 100, 1000)); 
    ...
    string defaultTubeCalibration = "../../../../Presets/Simulation/HitachiTubeCalibration.xml";
...
void GuiApp::keyPressed(int key)
{
    ...
    if (key == '7')   mainPtr->molSystem.addOrganisms(INTESTINE, 1);
    if (key == '8')   mainPtr->molSystem.addOrganisms(BREATHER,  1);
    if (key == '9')   mainPtr->molSystem.addOrganisms(PUMPER,    1);
    if (key == '0')   mainPtr->molSystem.addOrganisms(NEURON,    1);
