...
void GuiApp::setup(){
    ...
    guiSynthBrthrs.setName("BREATHERS");
        ...
        guiSynthBrthrs.add( mainPtr->sendChorusBreathers.set("send Chorus", -48, -48, 0) ); 
        guiSynthBrthrs.add( mainPtr->sendDelayBreathers.set("send Delay", -48, -48, 0) ); 
    ...
    guiSynthPumpers.setName("PUMPERS");
        ...
        guiSynthPumpers.add( mainPtr->sendChorusPumpers.set("send Chorus", -48, -48, 0) ); 
        guiSynthPumpers.add( mainPtr->sendDelayPumpers.set("send Delay", -48, -48, 0) ); 
    ...
    guiSynthNeurons.setName("NEURONS");
        ...
        guiSynthNeurons.add( mainPtr->sendChorusNeurons.set("send Chorus", -48, -48, 0) ); 
        guiSynthNeurons.add( mainPtr->sendDelayNeurons.set("send Delay", -48, -48, 0) ); 
    ...
    guiSynthIntestines.setName("INTESTINES");
        ...
        guiSynthIntestines.add( mainPtr->sendChorusIntestines.set("send Chorus", -48, -48, 0) ); 
        guiSynthIntestines.add( mainPtr->sendDelayIntestines.set("send Delay", -48, -48, 0) ); 
