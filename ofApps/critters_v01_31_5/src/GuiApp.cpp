...
void GuiApp::setup(){
    ...
    string defaultSimulationPreset = "Presets/Simulation/SimulationPreset.xml";   
    loadPreset(defaultSimulationPreset, 1);



    // LOAD DEFAULT TUBE CALIBRATION PRESETS
    string defaultTubeCalibration = "Presets/TubeCalibrations/PhilipsCRT.xml";
    loadPreset(defaultTubeCalibration, 1);


    // LOAD DEFAULT SYNTH PRESETS FOR EACH ORGANISM TYPE
    string defaultSynthPreset = "Presets/Synth/Breather.xml";
    loadPreset(defaultSynthPreset, 2);
        defaultSynthPreset = "Presets/Synth/Pumpers.xml";
    loadPreset(defaultSynthPreset, 2);
        defaultSynthPreset = "Presets/Synth/Neurons.xml";
    loadPreset(defaultSynthPreset, 2);
        defaultSynthPreset = "Presets/Synth/Intestines.xml";
    loadPreset(defaultSynthPreset, 2);

    string defaultFxPreset = "Presets/Synth/PostFX.xml";    
