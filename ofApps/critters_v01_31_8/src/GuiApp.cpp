...
void GuiApp::setup(){
    ...
    string defaultTubeCalibration = "../../../../Presets/TubeCalibrations/4screens_New02.xml";
    ...
    loadPreset(defaultSynthPreset, 2);
        defaultSynthPreset = "../../../../Presets/Synth/Pumpers10.xml";
    loadPreset(defaultSynthPreset, 2);
    ...
    string defaultFxPreset = "../../../../Presets/Synth/PostFX04.xml";    
