...
void GuiApp::setup(){
    ...
    // string defaultSimulationPreset = "../../../../Presets/Simulation/BreathersReTuned03.xml";   
    string defaultSimulationPreset = "../../../../Presets/Simulation/ArousalMap01.xml";   
    ...
    loadPreset(defaultSynthPreset, 2);
        defaultSynthPreset = "../../../../Presets/Synth/Pumpers09_forPhilips.xml";
    loadPreset(defaultSynthPreset, 2);
        defaultSynthPreset = "../../../../Presets/Synth/NeuronsUnderWater01.xml";
    loadPreset(defaultSynthPreset, 2);
        defaultSynthPreset = "../../../../Presets/Synth/Intestines06.xml";
    loadPreset(defaultSynthPreset, 2);
